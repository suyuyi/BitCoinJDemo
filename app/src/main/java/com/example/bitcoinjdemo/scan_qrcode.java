...
//        setSupportActionBar(mToolbar);
    ...
    private ScanCallback resultCallback = new ScanCallback() {
        ...
        public void onScanResult(String result) {
            ...
            intent.putExtra("QRcode", result);  //设置意图的内容
            setResult(1, intent);                        //设置结果码
            finish();
//            Toast.makeText(MainActivity.this, result, Toast.LENGTH_LONG).show();
        ...
        AndPermission.with(this)
                ...
                .callback(new PermissionListener() {
                    ...
                    public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
                        AndPermission.defaultSettingDialog(scan_qrcode.this).show();
                    }
                })
                .start();
    }
    ...
    private void startScanWithPermission() {
        if (mPreviewView.start()) {
            ...
            new AlertDialog.Builder(scan_qrcode.this)
                    .setTitle("相机连接失败")
